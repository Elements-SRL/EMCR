#ifndef SQUARECURRENTBASEDANALYSISCONSUMER_H
#define SQUARECURRENTBASEDANALYSISCONSUMER_H

#include "analysisconsumer.h"

class SquareCurrentBasedAnalysisConsumer : public AnalysisConsumer {
    Q_OBJECT

public:
    SquareCurrentBasedAnalysisConsumer(ApplicationStatus * appStatus, DeviceDataProducer * producer);
...
#endif // SQUARECURRENTBASEDANALYSISCONSUMER_H
